...
action :before_compile do
  ...
  # We create the virtualenv now to make it available early, for example
  # during the before_compile stage of the gunicorn subresource when
  # gunicorn may be installed in this virtualenv.
